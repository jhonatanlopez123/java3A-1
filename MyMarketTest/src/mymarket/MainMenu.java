...
public class MainMenu extends javax.swing.JFrame {
    ...
    public void listUsers(){
            ...
            try {
                ...
                while (rs.next()) {
                    users[0] = rs.getString("firstname");
                    users[1] = rs.getString("Lastname");
                    users[2] = rs.getString("Gender");
                    users[3] = rs.getString("Mobile");
                    users[4] = rs.getString("City");
                    users[5] = rs.getString("Email");
                    model.addRow(users);
                }
